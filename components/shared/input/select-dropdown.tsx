                            ...
                            >
                                {props.options.map((option, optionIdx) => (
                                    <Listbox.Option
                                        ...
                                        className={({ active }) =>
                                            clsx(
                                                active ? 'bg-primary text-white unicorn:bg-primary-container' : 'text-default',
                                    ...
                                    >
                                        {({ selected, active }) => (
                                            <>
                                                <span className={clsx(selected ? 'font-semibold' : 'font-normal', 'flex gap-1 truncate')}>
                                                    {option.name}
                                                    {option.verified && <CheckBadgeIcon className="h-5 w-5 text-primary-inverse" aria-hidden="true" />}
                                                </span>

                                                {selected ? (
                                                    <span
                                                        className={clsx(
                                                            active ? 'text-white' : 'text-on-primary-container',
