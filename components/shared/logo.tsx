...
export const Logo = ({...props}) => {
    /**
     * Derakuma Logo: MODIFICATIONS TO LOGO IS DISALLOWED. COPYRIGHT(C) SEGA CORPORATION.
     * Yipnyap Logo: Only colour modifications to logo are allowed.
     */
    // == For Derakuma ==
    props.className = cx('opacity-80 invert dark:invert-0 dark:opacity-100', props.className)
    ...
    return (
        ...
        // </svg>
        <Image src="/img/maimai/logo.png" alt="Derakuma logo" width="24" height="24" {...props} />
    )
}