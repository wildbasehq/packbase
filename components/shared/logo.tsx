...
export const Logo = ({...props}) => {
     ...
     */
    props.className = cx('opacity-80 invert-0 dark:invert dark:opacity-100', props.className)
    ...
    return (
        ...
        // </svg>
        <Image src="/img/logo.png" alt="Dummy lion logo" width="32" height="32" {...props} />
    )
}