...
export default function PostModal({postContent, setPostContent, signedInUser, onComment, postState}) {
    return (
        <div className="relative w-[42rem] max-w-2xl bg-neutral-50 dark:bg-n-8">
            ...
            <Card className="relative z-20 max-w-full! space-y-4 p-0! dark:border-2">
                <div className="px-4 py-4 sm:px-6">
                    ...
                    {postContent?.assets && postContent.assets.length > 0 && <MediaGrid assets={postContent.assets}/>}
                </div>
