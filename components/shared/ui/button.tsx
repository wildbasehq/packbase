...
const buttonVariants = cva(
    'inline-flex items-center justify-center whitespace-nowrap select-none rounded text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 hover:ring-4 hover:ring-n-5/10 disabled:cursor-not-allowed disabled:opacity-50',
    {
        variants: {
            variant: {
