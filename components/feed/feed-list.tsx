...
import FeedAnnouncement from './feed-announcement'
...
export default function FeedList({
    ...
    const containerClass = viewType === 2
        ? 'sm:flex sm:justify-center'
        : ''

    // Width class for list view to constrain width
    const widthClass = viewType === 2
        ? 'sm:w-screen sm:max-w-md'
        : ''
                    ...
                    <Masonry className="list-stagger" gutter="24px">
                        ...
                        {posts.map((post) => (
                            <FeedPost
                                ...
                                post={post}
                                postState={[posts, () => {
                                }]} // We handle post state in the parent component
