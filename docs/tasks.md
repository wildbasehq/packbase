...
6. [x] Implement unread counts and read receipts
   - [x] Update dm_participants.last_read_at when a channel is viewed
   - [x] Compute unread counts per channel on the server for sidebar listing
   - [x] Surface unread badge in apps/web sidebar and mark read on view/focus
7. [x] Add client-side optimistic UI for sending messages
...
8. [x] Implement infinite scroll and pagination on the client
...
15. [ ] Sidebar DM list enhancements
...
16. [ ] API pagination and filtering improvements
...
17. [ ] Audit and add missing indexes/constraints
...
18. [ ] Presence and typing indicators (optional but valuable)
...
21. [ ] Test coverage (Bun test + integration)
...
22. [ ] Performance improvements and caching
...
23. [ ] Developer experience and documentation
...
25. [ ] Error states for mapChannel
...
26. [ ] Secure attachments groundwork (future)
...
27. [ ] Client configuration consistency
...
29. [ ] Typing markdown shortcuts and toolbar UX
...
30. [ ] Consistent deleted and edited message rendering
...
34. [ ] Self-diagnostic route coverage
...
35. [ ] Internationalization and time formatting
...
36. [ ] Consistency in nullability and types
...
37. [ ] Prevent user enumeration in NewDM form
