    ...
    return (
        <>
            <div>
                ...
                <Heading className="mt-6" size="2xl" as="h2">Create a new account</Heading>
                ...
                <form method="POST" className="space-y-6" onSubmit={createUser}>
                    ...
                    <div>
                        <label htmlFor="password" className="block text-sm font-medium text-default mb-1">
                            Password
                            <p className="text-xs leading-5 text-alt">
                                at least 8 characters, 1 uppercase, 1 special character
                            </p>
                        </label>
                        <div
                            className="rounded-md shadow-sm ring-1 ring-neutral-300 dark:ring-white/20 overflow-visible">
                            <Input
                                combined
                                className="border-b border-n-3 dark:border-white/20 rounded-tr-md rounded-tl-md"
                                id="password"
                                label="Password"
                                type="password"
                                required
