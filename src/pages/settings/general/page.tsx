...
const ProfileSettings: React.FC = () => {
    ...
    const [handleInput, setHandleInput] = useState<string | undefined>(
        user?.username.indexOf('@') > -1 ? undefined : user?.username
    )
                ...
                <form onSubmit={saveProfile}>
                                ...
                                <div className="relative">
                                    <label htmlFor="username" className="text-default block text-sm font-medium leading-6">
                                        ...
                                        <Text size="xs" className="text-alt">
                                            Your username is used to find and reference you. Your Space URL holds your personal customised site.
                                        </Text>
                                    </label>
                    ...
                    />
                                ...
                                <div>
                                    ...
                                    <div
                                        className="relative mt-2 flex aspect-banner h-32 items-center justify-center overflow-hidden rounded border-2 border-dashed bg-card px-6 py-10"
                    ...
                    <div className="mt-6 flex items-center justify-end">
                        <Button
                            ...
                            color="indigo"
                            disabled={submitting}
                            className="flex justify-center rounded-md border border-transparent px-4 py-2 text-sm font-medium text-white shadow-xs focus:outline-hidden focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                        >
                            {!submitting ? 'Save Changes' : <LoadingCircle/>}
                        </Button>
                    </div>
                </form>
            </div>
