    ...
    return (
        <div className="p-6 max-w-lg">
            ...
            <form onSubmit={createPack}>
                ...
                <div className="mb-6">
                    <label className="block text-sm font-medium mb-1">Pack Slug</label>
    ...
    if (!user || user.anonUser) {
        return (
            <div className="py-16 px-4 text-center">
                ...
                <Text className="mt-4 text-neutral-500 max-w-md mx-auto">
        ...
        <div className="px-6 py-8 max-w-screen-xl mx-auto space-y-12">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 p-6">
                ...
                <div className="w-full max-w-xs">
                    <img
                        src="/img/illustrations/settings/friends.svg"
