...
export default function FloatingComposeButton() {
    ...
    return (
        <div className="fixed bottom-0 inset-x-0 ml-18 z-40 pointer-events-none">
            <div className="max-w-2xl mx-auto p-4">
                <button
                    onClick={handleClick}
                    className="pointer-events-auto w-full bg-sidebar backdrop-blur-xl border rounded shadow-lg hover:shadow-xl transition-all p-4 flex items-center gap-3 group"
                >
