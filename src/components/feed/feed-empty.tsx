 ...
 */
export default function FeedEmpty({ message = "Oddly enough, there's nothing to show you here." }: FeedEmptyProps) {
    return (
        <div className="flex flex-col items-center justify-center py-20">
            ...
            <Text className="mt-4 text-center text-muted-foreground dark:text-neutral-400">{message}</Text>
        </div>
    )
}
