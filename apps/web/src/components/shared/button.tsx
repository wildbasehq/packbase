...
const styles = {
    base: [
        ...
        // Active
        'data-active:scale-[1.02] md:data-active:scale-[0.98]',
        // Disabled
    ...
    colors: {
        ...
        amber: [
            'text-amber-950 [--btn-hover-overlay:var(--color-white)]/25 [--btn-bg-from:var(--color-amber-400)] [--btn-bg-to:var(--color-amber-500)] [--btn-border:var(--color-amber-500)]/80',
