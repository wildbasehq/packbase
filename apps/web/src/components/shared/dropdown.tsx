        ...
        <Headless.Transition leave="duration-100 ease-in" leaveTo="opacity-0">
            <Headless.MenuItems
                ...
                className={cn(
                    ...
                    // Base styles
                    'isolate w-max rounded-2xl p-1 z-50',
...
export function DropdownItem({
    ...
    let classes = cn(
        ...
        '*:data-[slot=icon]:fill-zinc-500 data-focus:*:data-[slot=icon]:fill-white dark:*:data-[slot=icon]:fill-zinc-400 dark:data-focus:*:data-[slot=icon]:fill-white',
        // Avatar
