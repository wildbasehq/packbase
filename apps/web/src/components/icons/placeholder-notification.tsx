export default function PlaceholderNotification({...props}) {
    return (
        <svg width="336" height="115" viewBox="0 0 336 115" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
            <rect x="0.464363" y="19.6227" width="300" height="64" rx="8" transform="rotate(-1 0.464363 19.6227)" fill="currentColor"/>
            <rect x="0.973013" y="20.1139" width="299" height="63" rx="7.5" transform="rotate(-1 0.973013 20.1139)" stroke="black" stroke-opacity="0.2"/>
            ...
            <rect x="60.093" y="36.1553" width="154" height="12" rx="2" transform="rotate(-1 60.093 36.1553)" fill="#D9D9D9"/>
            <rect x="60.3722" y="52.1528" width="84" height="12" rx="2" transform="rotate(-1 60.3722 52.1528)" fill="#D9D9D9" fill-opacity="0.65"/>

            <rect x="31.5441" y="34.3111" width="300" height="64" rx="8" transform="rotate(1.5 31.5441 34.3111)" fill="currentColor"/>
            <rect x="32.0309" y="34.824" width="299" height="63" rx="7.5" transform="rotate(1.5 32.0309 34.824)" stroke="black" stroke-opacity="0.2"/>
            ...
            <rect x="90.3949" y="53.4288" width="154" height="12" rx="2" transform="rotate(1.5 90.3949 53.4288)" fill="#D9D9D9"/>
            <rect x="89.976" y="69.4234" width="84" height="12" rx="2" transform="rotate(1.5 89.976 69.4234)" fill="#D9D9D9" fill-opacity="0.65"/>
            <g opacity="0.75" clip-path="url(#clip2_1_73)">
                <path
