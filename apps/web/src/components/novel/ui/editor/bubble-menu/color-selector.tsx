    ...
    return (
        <Popover modal open={open} onOpenChange={onOpenChange}>
            <PopoverTrigger asChild>
                <div className="gap-2 px-2 flex justify-center items-center rounded-none w-fit">
          <span
              className="rounded-sm mx-auto h-fit px-1"
              style={{
          ...
          >
            ...
            <PopoverContent
                sideOffset={5}
                className="my-1 flex max-h-80 bg-card w-48 flex-col overflow-hidden overflow-y-auto rounded border p-1 shadow-xl"
                align="start"
            >
