    ...
    return [
        ...
        },
        {
            ...
            command: ({
                          editor,
                          range
                      }: CommandProps) => editor.chain().focus().deleteRange(range).toggleCodeBlock().run(),
        },
        // {
        //     title: 'Image',
...
const CommandList = ({items, command, editor}: {
    ...
    return items.length > 0 ? (
        <div
            ...
            className="unicorn:text-on-surface-varaint z-50 h-auto max-h-[330px] w-72 overflow-y-auto rounded border bg-card px-1 py-2 shadow-md transition-all"
        >
