...
**THIS IS NOT PRODUCTION READY.** If you do run this, run it either air-gapped or in a sandbox network. Almost nothing
is finished.
...
Storage is up to you, and can be implemented with a plugin. The default is `MemoryBlockstore` which is lost on process
exit. Supabase and Prisma are the only "officially" supported plugins by Wolfbite Labs.
