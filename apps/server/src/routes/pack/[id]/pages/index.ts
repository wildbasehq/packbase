...
export default (app: YapockType) =>
    app.group('', app => app
        ...
        // Create a new page
        .post('', async ({params: {id}, set, user, body}) => {
        ...
        // Get a specific page
        .get('/:pageId', async ({params: {id, pageId}}) => {
        ...
        // Update a page
        .put('/:pageId', async ({params: {id, pageId}, set, user, body}) => {
            await requiresUserProfile({set, user})
            await pack.requiresOwnership({set, user, id})
        ...
        // Delete a page
        .delete('/:pageId', async ({params: {id, pageId}, set, user}) => {
            await requiresUserProfile({set, user})
            await pack.requiresOwnership({set, user, id})
        ...
        // Reorder pages
        .post('/reorder', async ({params: {id}, set, user, body}) => {
            await requiresUserProfile({set, user})
            await pack.requiresOwnership({set, user, id})
