...
const ALLOWED_PROPERTIES = new Set([
  ...
  'column-gap', 'row-gap', 'grid-auto-columns', 'grid-auto-rows',
  ...
  // Other
  'cursor', 'pointer-events', 'list-style', 'list-style-type', 'outline',
  'box-shadow', 'text-shadow', 'object-fit', 'object-position',
