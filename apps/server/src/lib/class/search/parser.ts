...
import { 
  Token, TokenType, ASTNode, NodeType, QueryNode, WhereClauseNode, 
  TableRefNode, ColumnRefNode, ExpressionNode, AndExprNode, OrExprNode, 
  NotExprNode, EqualsExprNode, GreaterThanExprNode, LessThanExprNode,
  GreaterThanEqualsExprNode, LessThanEqualsExprNode, BetweenExprNode,
  ExistsExprNode, SortExprNode, WildcardExprNode, FuzzyExprNode,
  ExactExprNode, CaseExprNode, StringLiteralNode, NumberLiteralNode,
  BooleanLiteralNode, NamedQueryRefNode, NamedQueryDefNode
} from './types';
      ...
      if (this.check(TokenType.STRING)) {
        ...
        if (this.match(TokenType.CLOSE_PAREN)) {
          ...
          return {
            ...
            value: stringLiteral,
            position: {
              start: { line: this.previous().position.line, column: this.previous().position.column - stringToken.value.length - 2 },
              end: { 
                line: this.previous().position.line, 
          ...
          if (this.check(TokenType.STRING)) {
            ...
            const rightExpr: EqualsExprNode = {
              ...
              position: {
                start: { line: rightStringToken.position.line, column: rightStringToken.position.column - 1 },
                end: { 
                  line: rightStringToken.position.line, 
