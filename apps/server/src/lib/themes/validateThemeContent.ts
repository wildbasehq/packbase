...
const ALLOWED_HTML_TAGS = ['div', 'span', 'p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'ul', 'ol', 'li', 'a', 'img', 'section', 'article', 'header', 'footer', 'nav', 'main', 'aside', 'style']
 ...
 */
export function validateThemeContent(
  content: ThemeContent,
  dryRun: boolean = false
): ValidatedThemeContent {
